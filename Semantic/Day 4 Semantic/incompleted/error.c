...
struct ErrorMessage errors[32] = {
  ...
  {ERR_FOR_INDEX_FLOAT, "Can not use float for index"},
  {ERR_FOR_INDEX_CHAR, "Can not use char for index"},
  {ERR_MODULO_OPERATOR, "Only integer number used for modulo operator"},
